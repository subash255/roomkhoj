...
<body class="bg-gray-100">
    ...
    <div class="border-4 border-black rounded-xl mt-8 mx-auto max-w-2xl p-6 bg-white shadow-md">
        <div class="flex justify-center mb-5">
            <img src="{{asset('image/rooms/'.$user->photopath)}}" alt="Profile Image" class="h-36 w-36 rounded-full object-cover shadow-lg">
        </div>
        ...
        <div class="profile-info">
            ...
            <h3 class="ml-2 text-lg">Phone Number: {{$user->phonenumber}}</h3>
            <h3 class="ml-2 text-lg">D.O.B:{{$user->dob}} </h3>
        </div>
